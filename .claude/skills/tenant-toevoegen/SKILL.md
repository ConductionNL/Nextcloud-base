...
Volg het cataloog (`docs/agents.md`); dit is een autonome operatie tot
en met de commit — de push doet een mens.
...
2. Naamconventie: `<org>-<accept|test|demo|prod>`; hostnames buiten
